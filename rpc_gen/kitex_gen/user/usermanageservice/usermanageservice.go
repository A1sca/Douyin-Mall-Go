...
var (
	userManageServiceServiceInfo                = NewServiceInfo()
	userManageServiceServiceInfoForClient       = NewServiceInfoForClient()
	userManageServiceServiceInfoForStreamClient = NewServiceInfoForStreamClient()
)

// for server
func serviceInfo() *kitex.ServiceInfo {
	return userManageServiceServiceInfo
}

// for client
func serviceInfoForStreamClient() *kitex.ServiceInfo {
	return userManageServiceServiceInfoForStreamClient
}

// for stream client
func serviceInfoForClient() *kitex.ServiceInfo {
	return userManageServiceServiceInfoForClient
}
...
func newServiceInfo(hasStreaming bool, keepStreamingMethods bool, keepNonStreamingMethods bool) *kitex.ServiceInfo {
	serviceName := "UserManageService"
	handlerType := (*user.UserManageService)(nil)
...
func getHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(user.UserManageService).Get(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *GetArgs:
		success, err := handler.(user.UserManageService).Get(ctx, s.Req)
		if err != nil {
			return err
		}
...
var GetArgs_Req_DEFAULT *user.GetReq

func (p *GetArgs) GetReq() *user.GetReq {
	if !p.IsSetReq() {
...
type GetResult struct {
	Success *user.GetResp
}

var GetResult_Success_DEFAULT *user.GetResp

func (p *GetResult) FastRead(buf []byte, _type int8, number int32) (n int, err error) {
	if !p.IsSetSuccess() {
		p.Success = new(user.GetResp)
	}
...
func (p *GetResult) GetSuccess() *user.GetResp {
	if !p.IsSetSuccess() {
...
func deleteHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(user.UserManageService).Delete(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *DeleteArgs:
		success, err := handler.(user.UserManageService).Delete(ctx, s.Req)
		if err != nil {
			return err
		}
...
func updateHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(user.UserManageService).Update(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *UpdateArgs:
		success, err := handler.(user.UserManageService).Update(ctx, s.Req)
		if err != nil {
			return err
		}
...
func (p *kClient) Get(ctx context.Context, Req *user.GetReq) (r *user.GetResp, err error) {
	var _args GetArgs
	_args.Req = Req
